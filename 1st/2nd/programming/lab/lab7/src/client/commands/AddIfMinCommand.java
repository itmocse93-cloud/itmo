...
public class AddIfMinCommand implements ClientCommand {
    ...
    public AddIfMinCommand(ServerConnection connection, ProductInputReader reader,
    ...
    public void execute(String[] args) {
        ...
        try {
            Response resp = connection.sendAndReceive(
                    new Request(CommandType.ADD_IF_MIN, product, login, passwordHash));
    ...
    @Override
    public String getDescription() { return "Add product if its price is less than the minimum"; }
}
